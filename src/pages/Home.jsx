...
import IconArrowRightShort from '../components/icons/IconArrowRight'
...
console.log(import.meta.env.VITE_BACKEND_URL)
  return (
    ...
    <div>
        <section
        className='flex flex-xol-reverse items-center justify-center py-5 md:flex-row md:gap-7 bg-gradient-to-r from-amber-50 to-orange-300'
        >
            <div
            className='w-4/6 ml-4 text-center md:w-2/6 md:text-left'
            >
                <div
                 className='flex justify-center text-4xl md:justify-normal'
                >
                    <h1
                ...
                <button className='flex items-center px-4 py-2 text-white bg-yellow-500 rounded-md hover:bg-yellow-600 group'>
                    Order Now
                    <span
                    className='inline-block ml-3 transition-transform ease-in-out group-hover:translate-x-2'
                    >
                        <IconArrowRightShort/>
                    </span>
                </button>
        ...
        >
            <div className='container flex flex-col md:flex-row mt-5'>
                ...
                <div
                className='flex flex-col flex-wrap text-center lg:py-6 lg:w-1/2 lg:p1-p2 lg:text-left'
                >
                    <div
                    className='flex flex-col items-center lg:items-start'
                    >
                        <div>
                            <h2 className='mb-2 text-5xl font-extrabold text-transparent title-font bg-gradient-to-r from-orange-600 to-orange-300 bg-clip-text ml-7'>
                                Cooked by the best <br/> chefs in the world
                            </h2>
                            <p className='text-base leading-relaxed text-[#6B7280] ml-7'>
               ...
               <div className='w-full p-1 mt-5'>
                ...
                <div className='px-5 py-4 mx-auto mt-5'>
                    <div className='flex justify-center py-4'>
                        <div className='inline-flex w-16 h-1 bg-yellow-500 rounded-full'></div>
                    </div>
                    <div
                    className='flex flex-wrap space y-6 md:space-y-0'
                    >
                        <div
                        className='flex flex-col items-center text-center p-4 md:w-1/3'
                        >
                            <div
                            className='inline-flex items-center justify-center flex-shrink-0 w-20 h-20 mb-5 bg-yellow-100 rounded-full'
                            >
                                <img src={OrderFood}/>
                            </div>
